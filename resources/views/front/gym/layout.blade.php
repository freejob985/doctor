...
<html lang="en">
   <head>
    ...
    color: #55b9ea;
}.service_slide img{height:280px;}
.blog-img-wrapper img {
    ...
    padding: 209px 0 104px;}.feature_v1 {
    margin-top: 0px;
    position: relative;
}.service_slide.finlance_img img {
    width: 100%;
    height: 250px;
    ...
    z-index: -1;
    transition: all .3s;
}.single_slider .bg_image .slick-slide{background-color: rgba(12, 19, 172, 0.3)!important;}
...
@media only screen and (max-width: 767px){.brand a img{width:70px;}.banner_v1 {
    position: relative;
    height: 422px;
}.hero_slide_v1 .single_slider {
    height: 422px;
    padding: 179px 0 74px;
