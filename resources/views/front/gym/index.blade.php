...
@section('content')
        ...
        <section class="finlance_feature feature_v1">
                ...
                <div class="row no-gutters">
                    @foreach ($features as $key => $feature)
                        <div class="col-lg-3 col-md-6 col-sm-12 wow zoomIn">
                ...
                <div class="service_slide service-slick">
                    ...
                    @elseif (!hasCategory($be->theme_version))
                        @foreach ($services as $key => $service)
                            <div class="grid_item wow zoomIn">
                                <div class="grid_inner_item">
                                    @if (!empty($service->main_image))
                                        <div class="finlance_img">
                                            <img style="height:250px;" src="{{asset('assets/front/img/services/' . $service->main_image)}}" alt="service" />
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12">
                        <div class="counter_box wow slideInDow">
                            <div class="icon">
        ...
        <section class="finlance_testimonial testimonial_v1 pt-115 pb-120">
            <div class="container">
                ...
                <div class="testimonial_slide wow slideInDown">
