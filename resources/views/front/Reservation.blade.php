    ...
    <div class="container">
      ...
      <div class="form-row">
        ...
        <div class="col-md-8 mb-4">
          ...
          <input style="
    display: none;
" style="background:blue;padding:33px;" type="date" placeholder="Please enter data" class="form-control day"
            dateformat="d M y" name="day" id="date_input" min="1997-01-01" max="2030-12-31">
...
<div id="img" class="text-center" style="display: none">
  <div class="container">
    <div class="row">
      <img class="img-responsive center-block" style="width:200px;"
        src="https://i.pinimg.com/originals/78/e8/26/78e826ca1b9351214dfdd5e47f7e2024.gif" alt="Chania">
    </div>
  </div>
</div>
<!--   quote area start   -->
